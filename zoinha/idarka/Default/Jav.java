...
//!	Generated Date	: Sat, 28, May 2011 
	File Path	: zoinha/idarka/Default/Jav.java
*********************************************************************/
...
public class Jav implements RiJStateConcept, Animated {
    ...
    */
    ...
    public static final int zbieranie_kodu=3;
    public static final int wydawanie=4;
    public static final int wydano=5;
    public static final int wybor_produktu=6;
    public static final int Ustalanie=7;
    public static final int state_3=8;
    public static final int start_maszyny=9;
    ...
    public static final int Jav_Timeout_znaleziono_produkt_sms_id = 1;		//## ignore 
    
    public static final int Jav_Timeout_znaleziono_id = 2;		//## ignore 
    
    public static final int Jav_Timeout_wydawanie_id = 3;		//## ignore 
    
    public static final int Jav_Timeout_wydano_id = 4;		//## ignore 
    
    public static final int Jav_Timeout_wybor_produktu_id = 5;		//## ignore 
    
    public static final int Jav_Timeout_Start_id = 6;		//## ignore 
    
    public static final int Jav_Timeout_platnosc_sms_id = 7;		//## ignore 
    
    public static final int Jav_Timeout_nie_znaleziono_id = 8;		//## ignore 
    ...
    public class Reactive extends RiJStateReactive implements AnimatedReactive {
        ...
        public int rootState_dispatchEvent(short id) {
            ...
            switch (rootState_active) {
                ...
                case zbieranie_kodu:
                {
                    res = zbieranie_kodu_takeEvent(id);
                }
                break;
                default:
                    break;
        ...
        //## statechart_method 
        public void zbieranie_kodu_add(AnimStates animStates) {
            animStates.add("ROOT.zbieranie_kodu");
        }
        ...
        //## statechart_method 
        public int zbieranie_kodu_takeEvent(short id) {
            int res = RiJStateReactive.TAKE_EVENT_NOT_CONSUMED;
            return res;
        }
        ...
        //## statechart_method 
        public void zbieranie_kodu_enter() {
            animInstance().notifyStateEntered("ROOT.zbieranie_kodu");
            rootState_subState = zbieranie_kodu;
            rootState_active = zbieranie_kodu;
            zbieranie_koduEnter();
        }
        
        //## statechart_method 
        public void zbieranie_koduEnter() {
            //#[ state ROOT.zbieranie_kodu.(Entry) 
        ...
        public void znaleziono_produkt_smsEnter() {
            ...
            //#]
            itsRiJThread.schedTimeout(1000, Jav_Timeout_znaleziono_produkt_sms_id, this, "ROOT.znaleziono_produkt_sms");
        }
        ...
        //## statechart_method 
        public void zbieranie_kodu_entDef() {
            zbieranie_kodu_enter();
        }
        ...
        public int znaleziono_produkt_sms_takeEvent(short id) {
            ...
            if(event.isTypeOf(RiJEvent.TIMEOUT_EVENT_ID))
                {
                    res = znaleziono_produkt_smsTakeRiJTimeout();
                }
        ...
        //## statechart_method 
        public void zbieranie_kodu_exit() {
            zbieranie_koduExit();
            animInstance().notifyStateExited("ROOT.zbieranie_kodu");
        }
        ...
        //## statechart_method 
        public void zbieranie_koduExit() {
        }
        ...
        public void start_maszynyEnter() {
            ...
            /*if(id_product == 0)
                ...
                id_product = poziom;
              */
            lancuch = "Wybrano produkt: " + id_product;
            //#]
        }
        ...
        public void znaleziono_produkt_smsExit() {
            itsRiJThread.unschedTimeout(Jav_Timeout_znaleziono_produkt_sms_id, this);
        }
        ...
        //## statechart_method 
        public int znaleziono_produkt_smsTakeRiJTimeout() {
            int res = RiJStateReactive.TAKE_EVENT_NOT_CONSUMED;
            if(event.getTimeoutId() == Jav_Timeout_znaleziono_produkt_sms_id)
                {
                    animInstance().notifyTransitionStarted("24");
                    znaleziono_produkt_sms_exit();
                    zbieranie_kodu_entDef();
