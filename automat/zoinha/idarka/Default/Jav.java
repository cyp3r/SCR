...
public class Jav implements RiJStateConcept, Animated {
    ...
    public static AnimClass animClassJav$wrzutnia = new AnimClass("Default.Jav$wrzutnia",false);
    //#]
    ...
    */
    ...
    public static final int start_maszyny=6;
    public static final int nie_znaleziono=7;
    public static final int napisy_poczatkowe=8;
    //#]
    ...
    */
    ...
    public class Reactive extends RiJStateReactive implements AnimatedReactive {
        ...
        public void wydanoEnter() {
            ...
            //#]
            itsRiJThread.schedTimeout(2000, Jav_Timeout_wydano_id, this, "ROOT.wydano");
        }
        ...
        public void UstalanieEnter() {
            ...
            przyporzadkowanie = new Produkt("sok £ukaszek", new Integer(300));
            ...
            przyporzadkowanie = new Produkt("sok Jaromiœ", new Integer(200));
        ...
        public void wydawanieEnter() {
            ...
            //#]
            itsRiJThread.schedTimeout(10000, Jav_Timeout_wydawanie_id, this, "ROOT.wydawanie");
        }
    ...
    public class wrzutnia implements RiJStateConcept, Animated {
        ...
        public  wrzutnia(RiJThread p_thread) {
            try {
                animInstance().notifyConstructorEntered(animClassJav$wrzutnia.getUserClass(),
                   new ArgData[] {
                   });
